...
class Level:
    ...
    def create_tile_group(self, layout, object_type):
    ...
    def scroll_x(self):
        ...
        screen_shift = int(screen_width / 2)

        if player_x < screen_shift and direction_x < 0:
            self.world_shift = 8
            player.speed = 0
        elif player_x > (screen_width - screen_shift) and direction_x > 0:
            self.world_shift = -8
            player.speed = 0
        else:
            self.world_shift = 0
